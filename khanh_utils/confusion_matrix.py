...
class DetectionConfusionMatrix:
    ...
    def compute_PR_from_matrix(self, confusion_matrix):
        ...
        precision_recall_metrics['precision/parasitized_weighted_precision'] = weighted_precision
        precision_recall_metrics['recall/parasitized_weighted_recall'] = weighted_recall
